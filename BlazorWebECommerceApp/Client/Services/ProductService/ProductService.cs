...
namespace BlazorWebECommerceApp.Client.Services.ProductService
{
    public class ProductService : IProductService
    {
        ...
        public async Task GetProducts(string? categoryUrl = null, int? page = null)
        {
            if (categoryUrl == null)
            {
