...
namespace BlazorWebECommerceApp.Server.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<ActionResult<ServiceResponse<ProductSearchResult>>>
            GetProductByCategoryUrl(string categoryUrl, int page = 1)
        {
        ...
        {
            var result = await _productService.GetProductSearchTextSuggestions(searchText);
            return Ok(result);
        }
        ...
        public async Task<ActionResult<ServiceResponse<Product>>>
